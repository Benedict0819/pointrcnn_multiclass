...
class PointRCNN(nn.Module):
    ...
    def forward(self, input_data):
        if cfg.RPN.ENABLED: # RPN.ENABLED=TRUE, RPN.FIXED=FALSE
            ...
            raise NotImplementedError
        # print("output check : rpn_cls", output['rpn_cls'].size()) # size([16,16384,1])
        # print("output check : rpn_reg", output['rpn_reg'].size()) # size([16,16384,76])
        # print("output check : backbone_xyz", output['backbone_xyz'].size()) # size([16,16384,3])
        # print("output check : backbone_features", output['backbone_features'].size()) # size([16,128,16384])
