...
class GTDatabaseGenerator(KittiDataset):
    def __init__(self, root_dir, split='train', classes=args.class_name):
        ...
        if classes == 'Car':
            ...
            self.classes = ('Background', 'Pedestrian', 'Cyclist', 'Car')
        elif classes == 'People':
...
if __name__ == '__main__':
    ...
    gt_database = pickle.load(open('gt_database/train_gt_database_3level_Multiclass.pkl', 'rb'))
    print(gt_database.__len__()) # Car : 11017, Multiclass : 13727
    #### print(gt_database) # too many values
    import pdb
    pdb.set_trace()
